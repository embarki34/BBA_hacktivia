...
// Check if the employee is already logged in, if not, then redirect them to the employee login page
...
<div class="container">
    ...
    <h3>QR Code for Your Employee ID:</h3>
    <div id="qrcode"></div>
    <br>
    <br>
    <br>
...
<script>
    ...
    qrCode.src = "https://api.qrserver.com/v1/create-qr-code/?data=" + encodeURIComponent(employeeId) + "&size=200x200";
